...
module.exports = {
  ...
  // ex. 'http://my-site.com'
  appUrl: 'https://koala-update-koala-update-server.1d35.starter-us-east-1.openshiftapps.com',

  auth: {
    // Provide a set of credentials that can be used to access the admin interface.
    static: {
      username: 'koalaupdate',
      password: 'Sup3r1lk00l0!'
    },
  ...
  connections: {
        ...
        password: 'EB9F0CA4414893F7B72DDF0F8507D88042DB4DBF8BD9D0A5279ADB54158EB2F0',
